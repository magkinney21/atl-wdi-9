...
An advantage is it is simplistic.
A disadvantage is that they do not specify how many stops.
...
A--The first option has the patient and appointment under the doctors variable, allowing it to condense some of the info and helps organize in a sense, but tends to reiterate information.
The second option is better because it is more straight to the point. The second might be better for speed while the first may be better for being more precise/thorough.
...
c.  Justify your choices in a) and b). Why these entities? Why these
    representations?
A-I believe these are some options that would be need for a game of tic tac toe.
B- I am hoping this is currect.
